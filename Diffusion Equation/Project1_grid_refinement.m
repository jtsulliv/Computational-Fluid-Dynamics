...
nu = 0.000217;               %KINEMATIC VISCOSITY [m^2/s]
h = 0.04;                    %DISTANCE BETWEEN THE PLATES [m]
N_4 = 21;                      %NUMBER OF NODES IN THE y DIRECTION
del_t_4 = 0.0025                %DISCRETIZATION IN TIME [s]
t_final = .18                %END TIME [s]
U_0 = 40;

del_y_4 = h/(N_4-1)             %DISCRETIZATION IN y [m]
d_4 = (nu*del_t_4)/(del_y_4^2)    %STABILITY CONDITION FOR THE FTCS SCHEME
...
nu = 0.000217;               %KINEMATIC VISCOSITY [m^2/s]
h = 0.04;                    %DISTANCE BETWEEN THE PLATES [m]
N_5 = 41;                      %NUMBER OF NODES IN THE y DIRECTION
del_t_5 = 0.000625                %DISCRETIZATION IN TIME [s]
t_final = .18                %END TIME [s]
U_0 = 40;

del_y_5 = h/(N_5-1)             %DISCRETIZATION IN y [m]
d_5 = (nu*del_t_5)/(del_y_5^2)    %STABILITY CONDITION FOR THE FTCS SCHEME
...
title('Velocity profile at t=0.18 s')
